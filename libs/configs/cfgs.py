...
# ------------------------------------------------
VERSION = 'R2CNN_20181206_ICDAR2015_v1'
...
TEST_ANNOTATION_PATH = '/home/sws/code/Tfrecord/VOCdevkit/VOCdevkit_test/Annotations'
...
MOMENTUM = 0.9
LR = 0.0003  # 0.0003
DECAY_STEP = [30000, 80000]  # 90000, 120000
...
ANCHOR_STRIDE = [4, 16]  # can not be modified in most situations
ANCHOR_SCALES = [[0.125, 0.25, 0.5, 1., 1.5, 2.0],[0.125, 0.25, 0.5, 1.,2]]  # [4, 8, 16, 32]
ANCHOR_RATIOS = [[1, 1 / 2, 2., 1 / 3., 3., 5., 1 / 4., 4., 1 / 5.],
                 [1, 1 / 2, 2., 1 / 3., 3., 5., 1 / 4., 4., 5, 1 / 5, 6, 1 / 6, 7, 1 / 7,]]
# LEVEL = ['C2', 'C4']
# BASE_ANCHOR_SIZE_LIST = [64, 256]  # can be modified
# ANCHOR_STRIDE = [4, 16]  # can not be modified in most situations
# ANCHOR_SCALES = [[0.25, 0.5, 1., 2], [0.125, 0.25, 0.5, 1.,]]  # [4, 8, 16, 32]
# ANCHOR_RATIOS = [[1, 1 / 2, 2., 1 / 3., 3., 5., 1 / 4., 4.],
#                 [1, 1 / 2, 2., 1 / 3., 3., 5., 1 / 4., 4., ]]
